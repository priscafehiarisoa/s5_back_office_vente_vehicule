...
import {IconArrowAutofitDown, IconCirclePlus, IconCodePlus, IconRating14Plus} from "@tabler/icons";

// ==============================|| DASHBOARD DEFAULT - POPULAR CARD ||============================== //

const TopNCategories = ({ isLoading }) => {
            ...
            <Grid container spacing={gridSpacing}>
              <Grid item xs={12}>
                <Grid container spacing={2} alignContent="center" justifyContent="space-between">
                  <Grid item xs={10}>
                    <Typography variant="h4">Top {nombre} des Categories les plus vendues</Typography>
                  </Grid >
                  <Grid item xs={2}>
